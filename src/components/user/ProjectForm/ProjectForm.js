      ...
      >
        {({ values, errors, touched, handleChange, isSubmitting }) => (
          <Form className="project-form">
            ...
            <FormGroup>
              <FormLabel htmlFor="projectCreationDate">Creation Date</FormLabel>
              <Field
                type="text"
            ...
            <FormGroup>
              ...
              {touched.targetParticipantNumber &&
                errors.targetParticipantNumber && (
                  <div className="error">{errors.targetParticipantNumber}</div>
                )}
            </FormGroup>
            ...
            <FormGroup>
              ...
              {touched.actualParticipantNumber &&
                errors.actualParticipantNumber && (
                  <div className="error">{errors.actualParticipantNumber}</div>
                )}
            </FormGroup>
            <FormGroup>
